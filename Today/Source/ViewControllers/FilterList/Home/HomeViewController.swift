...
//        navigationItem.leftBarButtonItem = UIBarButtonItem(image: #imageLiteral(resourceName: "런치패드용"), style: .plain, target: nil, action: nil)
...
//    }
    ...
    private func createBasicTypeSection() -> NSCollectionLayoutSection {
        ...
        if UIDevice.current.userInterfaceIdiom == .pad {
            //pad 일 경우
            //item
            let itemSize = NSCollectionLayoutSize(widthDimension: .fractionalWidth(0.45), heightDimension: .fractionalHeight(1.325))
    ...
    private func createLargeTypeSection() -> NSCollectionLayoutSection {
        if UIDevice.current.userInterfaceIdiom == .pad {
            //iphone
            //item
            let itemSize = NSCollectionLayoutSize(widthDimension: .fractionalWidth(0.2), heightDimension: .fractionalHeight(0.825))
            let item = NSCollectionLayoutItem(layoutSize: itemSize)
            item.contentInsets = .init(top: 15, leading: 7.5, bottom: 0, trailing: 7.5)
            //group
            let groupSize = NSCollectionLayoutSize(widthDimension: .fractionalWidth(1.35), heightDimension: .estimated(600))
    ...
    NSCollectionLayoutSection {
        if UIDevice.current.userInterfaceIdiom == .pad {
            let itemSize = NSCollectionLayoutSize(widthDimension: .fractionalWidth(0.45), heightDimension: .fractionalHeight(1.025))
            let item = NSCollectionLayoutItem(layoutSize: itemSize)
            item.contentInsets = .init(top: 10, leading: 5, bottom: 0, trailing: 5)
            //group
            let groupSize = NSCollectionLayoutSize(widthDimension: .fractionalWidth(0.9), heightDimension: .estimated(200))
